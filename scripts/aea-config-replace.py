...
def main() -> None:
    ...
    with open(Path("alprina_stock_analyst_agent", "aea-config.yaml"), "r", encoding="utf-8") as file:
    ...
    with open(Path("alprina_stock_analyst_agent", "aea-config.yaml"), "w", encoding="utf-8") as file:
