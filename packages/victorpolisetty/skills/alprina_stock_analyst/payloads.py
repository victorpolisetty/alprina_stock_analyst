...
"""This module contains the transaction payloads of the AlprinaStockAnalystAbciApp."""
...
class CollectStockDataPayload(BaseTxPayload):
...
@dataclass(frozen=True)
class AggregateFinancialReportPayload(BaseTxPayload):
